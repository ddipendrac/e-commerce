...
import dbConnect from "@/utils/db"; // Function to establish a database connection.
import UserModel from "@/models/User"; // Mongoose model for the User collection in the database.
