...
import dbConnect from "@/utils/db"; // Import database connection function
import UserModel from "@/models/User"; // Import User model for database operations
  ...
  try {
    ...
    if (!emailResponse.success) {
      return Response.json(
        {
          success: false,
          message: "Eroor while responsing email", // Return email error message
        },
